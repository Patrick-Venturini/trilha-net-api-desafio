...
namespace TrilhaApiDesafio.Controllers
{
    ...
    public class TarefaController : ControllerBase
    {
        ...
        {
            //var tarefa = _context.Tarefas.Where(x => x.Status == status);// TODO: Buscar  as tarefas no banco utilizando o EF, que contenha o status recebido por parâmetro
            // Dica: Usar como exemplo o endpoint ObterPorData
        ...
        public IActionResult Deletar(int id)
        {
            ...
            _context.Tarefas.Remove(tarefaBanco);// TODO: Remover a tarefa encontrada através do EF e salvar as mudanças (save changes)
            _context.SaveChanges();
            return NoContent();
        }
    }
